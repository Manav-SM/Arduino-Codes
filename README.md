...
<p style="text-align: justify">
  To control the board remotely through calls and recieve an sms of the result,
  using the inbuilt GSM module.
</p>
...
### Program to use an external GPS module.

<p style="text-align: justify">
  To calculate the distance to a custom location from the current location using
